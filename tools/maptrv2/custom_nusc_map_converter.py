...
def create_nuscenes_infos(root_path,
    ...
    import splits
    available_vers = ['v1.0-trainval', 'v1.0-test', 'v1.0-mini','domain']
    ...
    if version == 'v1.0-trainval':
        ...
        train_scenes = splits.boston
        val_scenes = splits.singapore_val
    else:
    ...
    if test:
        ...
        data = dict(infos=train_nusc_infos, metadata=metadata)
        info_path = osp.join(out_path,
                             '{}_map_infos_temporal_train_boston.pkl'.format(info_prefix))
        mmcv.dump(data, info_path)
        data['infos'] = val_nusc_infos
        info_val_path = osp.join(out_path,
                                 '{}_map_infos_temporal_val_singapore.pkl'.format(info_prefix))
...
parser.add_argument(
    '--root-path',
    type=str,
    default='/data0/lsy/dataset/nuScenes/v1.0',
...
parser.add_argument(
    '--out-dir',
    type=str,
    default='/data0/lsy/dataset/nuScenes/v1.0/tra_pkl',
    required=False,
...
if __name__ == '__main__':
    train_version = args.version  # f'{args.version}-trainval'
    nuscenes_data_prep(
