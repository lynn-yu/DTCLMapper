...
class NormalizeMultiviewImage(object):
    ...
    def __call__(self, results):
        ...
        if 'scale_img' in results:
            results['scale_img'] = [mmcv.imnormalize(img, self.mean, self.std, self.to_rgb) for img in results['scale_img']]
...
class CustomCollect3D(object):
    ...
    def __init__(self,
                 ...
                 meta_keys=('filename', 'ori_shape', 'img_shape', 'lidar2img',
                            ...
                            'can_bus','lidar2global','R','T','post_rot','post_tran',
                            'camera2ego','camera_intrinsics','img_aug_matrix','lidar2ego','ego_motion','pre2now_futuremotion','gt_depth'
                            )):
        self.keys = keys
